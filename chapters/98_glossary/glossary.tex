...
\newglossaryentry{Knative}{
    name=Knative,
    description={Knative is an Open-Source Enterprise-level solution to build Serverless and Event Driven Applications. Serverless Containers in Kubernetes environments.}
}
\newglossaryentry{ICMP}{
    name=ICMP,
    description={ICMP, short for Internet Control Message Protocol, is a network layer protocol that operates at the network layer (Layer 3) of the OSI model. It is used for error reporting, network diagnostics, and network congestion control.}
}
