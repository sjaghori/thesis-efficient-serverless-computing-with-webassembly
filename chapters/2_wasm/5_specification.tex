...
%The MVP version of WebAssembly aimed for language features that were common to all programming languages, everything else was left to be added in the post MVP versions \cite{sletten_2021_webassembly}. 
